		...
		<section class="bt-no-search-results bt_bb_section bt_bb_top_spacing_large bt_bb_bottom_spacing_large gutter">
			...
			<div class="bt_bb_port">
				...
				<form role="search" method="get" id="searchform" class="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
					<input type="search" value="<?php echo esc_attr( get_search_query() )  ?>" placeholder="<?php echo esc_attr__( 'Enter search term', 'novalab')  ?>" name="s" id="s" >
					<input type="submit" value="<?php echo esc_attr__( 'Search', 'novalab')  ?>">
				</form>
				...
				<?php
					echo boldthemes_get_button_html( 
						array (
							'url' => home_url( '/' ), 
							'text' => esc_html__( 'BACK TO HOME', 'novalab' ), 
							'style' => 'filled',
