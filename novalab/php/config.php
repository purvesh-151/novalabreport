...
if ( ! function_exists( 'novalab_color_schemes' ) ) {
	function novalab_color_schemes( $color_scheme_arr ) {
		...
		$theme_color_schemes[] = 'gray-background;Dark font, light gray background;#191919;#f8f9fb';
		$theme_color_schemes[] = 'gray-accent-skin;Gray font, accent background (or details);#cccccc;' . boldthemes_get_option( 'accent_color' );

		$theme_color_schemes[] = 'alternate-gray-skin;Alternate font, blue-gray background (or details);' . boldthemes_get_option( 'alternate_color' ) . ';#eaeef3';
		$theme_color_schemes[] = 'dark-gray-skin;Dark font, blue-gray background (or details);#191919;#eaeef3';
